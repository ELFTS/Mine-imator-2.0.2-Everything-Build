/// model_shape_generate_block_loc(bend)
/// @arg bend
/// @desc Generates a block shape transformed by a bend vector.

function model_shape_generate_block_loc(bend)
{
	// Block dimensions
	...
	vertex_rgb_loc = vertex_rgb 
	vertex_alpha_loc = vertex_alpha
	vbuffer_current_loc = vbuffer_current
	vertex_format_loc = vertex_format
	vertex_subsurface_loc = vertex_subsurface
	
	/// CppOnly #pragma omp parallel num_threads(2) 
	{
	/// CppOnly if (omp_get_thread_num() == 1)
	{
	...
	vertex_emissive_loc = color_emissive
	vertex_wave_loc = wind_wave
	vertex_wave_zmin_loc = wind_wave_zmin
	vertex_wave_zmax_loc = wind_wave_zmax
	...
	while (true)
	{
		...
		if (segpos >= size[segaxis] - 0.0001)
		{
			switch (segaxis)
			{
				case X: case Y:
				{
					...
					vbuffer_add_triangle_loc(p2, p1, p4, texend1, texend2, texend3, null, null, null, invert)
					vbuffer_add_triangle_loc(p4, p3, p2, texend3, texend4, texend1, null, null, null, invert)
					break
				}
				...
				case Z:
				{
					...
					vbuffer_add_triangle_loc(p4, p3, p2, texend1, texend2, texend3, null, null, null, invert)
					vbuffer_add_triangle_loc(p2, p1, p4, texend3, texend4, texend1, null, null, null, invert)
					break
				}
			}
			break
		...
		if (segpos = 0)
		{
			vbuffer_add_triangle_loc(p1, p2, p3, texstart1, texstart2, texstart3, null, null, null, invert)
			vbuffer_add_triangle_loc(p3, p4, p1, texstart3, texstart4, texstart1, null, null, null, invert)
		}
		...
		switch (segaxis)
		{
			case X:
			{
				...
				vbuffer_add_triangle_loc(p2, np2, np3, t1, t2, t3, n1, nn1, nn1, invert)
				vbuffer_add_triangle_loc(np3, p3, p2, t3, t4, t1, nn1, n1, n1, invert)
				...
				vbuffer_add_triangle_loc(np1, p1, p4, t1, t2, t3, nn2, n2, n2, invert)
				vbuffer_add_triangle_loc(p4, np4, np1, t3, t4, t1, n2, nn2, nn2, invert)
				...
				vbuffer_add_triangle_loc(p1, np1, np2, t1, t2, t3, n3, nn3, nn3, invert)
				vbuffer_add_triangle_loc(np2, p2, p1, t3, t4, t1, nn3, n3, n3, invert)
				...
				vbuffer_add_triangle_loc(p3, np3, np4, t1, t2, t3, n4, nn4, nn4, invert)
				vbuffer_add_triangle_loc(np4, p4, p3, t3, t4, t1, nn4, n4, n4, invert)
			...
			case Y:
			{
				...
				vbuffer_add_triangle_loc(np1, p1, p4, t1, t2, t3, nn1, n1, n1, invert)
				vbuffer_add_triangle_loc(p4, np4, np1, t3, t4, t1, n1, nn1, nn1, invert)
				...
				vbuffer_add_triangle_loc(p2, np2, np3, t1, t2, t3, n2, nn2, nn2, invert)
				vbuffer_add_triangle_loc(np3, p3, p2, t3, t4, t1, nn2, n2, n2, invert)
				...
				vbuffer_add_triangle_loc(p2, p1, np1, t1, t2, t3, n3, n3, nn3, invert)
				vbuffer_add_triangle_loc(np1, np2, p2, t3, t4, t1, nn3, nn3, n3, invert)
				...
				vbuffer_add_triangle_loc(np3, np4, p4, t1, t2, t3, nn4, nn4, n4, invert)
				vbuffer_add_triangle_loc(p4, p3, np3, t3, t4, t1, n4, n4, nn4, invert)
			...
			case Z:
			{
				...
				vbuffer_add_triangle_loc(np2, np3, p3, t1, t2, t3, nn1, nn1, n1, invert)
				vbuffer_add_triangle_loc(p3, p2, np2, t3, t4, t1, n1, n1, nn1, invert)
				...
				vbuffer_add_triangle_loc(np4, np1, p1, t1, t2, t3, nn2, nn2, n2, invert)
				vbuffer_add_triangle_loc(p1, p4, np4, t3, t4, t1, n2, n2, nn2, invert)
				...
				vbuffer_add_triangle_loc(np1, np2, p2, t1, t2, t3, nn3, nn3, n3, invert)
				vbuffer_add_triangle_loc(p2, p1, np1, t3, t4, t1, n3, n3, nn3, invert)
	...
	vertex_emissive_loc = 0
	vertex_wave_loc = e_vertex_wave.NONE
	vertex_wave_zmin_loc = null
	vertex_wave_zmax_loc = null
	
	return vbuffer_done_loc()
}
