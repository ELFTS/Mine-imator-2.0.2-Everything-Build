/// menu_transition_easeinout(x, y, width, height)
/// @arg x
/// @arg y
/// @arg width
/// @arg height

function menu_transition_easeinout(xx, yy, wid, hei)
{
	var transition = null;
	dx_start = xx + 12
	dx = dx_start
	...
	if (settings_menu_name != "" && transition != null) // Settings menu
	{
		...
		// Save this transition as the new default for the Ease In/Out button
		timeline.transition_easeinout = transition
