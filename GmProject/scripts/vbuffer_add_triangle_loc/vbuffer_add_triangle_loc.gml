/// vbuffer_add_triangle_loc(pos1, pos2, pos3, texcoord1, texcoord2, texcoord3, [normal1, normal2, normal3, [invert, [matrix]]])
/// OR vbuffer_add_triangle_loc(x1, y1, z1, x2, y2, z2, x3, y3, z3, tx1, ty1, tx2, ty2, tx3, ty3, [invert, [matrix]])
/// @arg pos1
/// @arg pos2
/// @arg pos3
/// @arg texcoord1
...
function vbuffer_add_triangle_loc()
{
	if (argument_count < 15)
	{
		...
		vertex_add_loc(pos1, normal1, tex1)
		vertex_add_loc(pos2, normal2, tex2)
		vertex_add_loc(pos3, normal3, tex3)
	}
	else
	{
		...
		vertex_add_loc(x1, y1, z1, nx, ny, nz, tx1, ty1)
		vertex_add_loc(x2, y2, z2, nx, ny, nz, tx2, ty2)
		vertex_add_loc(x3, y3, z3, nx, ny, nz, tx3, ty3)
	}
}
